          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-600">Jiu-Jitsu Feminino</div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-5xl lg:text-6xl mb-6 text-black">
              Jiu-Jitsu Feminino na Escola Demian
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Descubra como nossas aulas especializadas empoderam mulheres através da arte suave
            </p>
          </div>
          ...
          <div className="relative aspect-video bg-gray-900 rounded-2xl overflow-hidden shadow-2xl group cursor-pointer">
            <ImageWithFallback 
              ...
              alt="Treino de Jiu-Jitsu Feminino"
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-8">
              <h3 className="text-2xl text-white mb-2">Como Funciona o Treino para Mulheres</h3>
              <p className="text-white/90">Veja como é uma aula típica e conheça nossa metodologia exclusiva</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl">
              ...
              <div className="text-gray-600">Alunas Ativas</div>
            </div>
            <div className="text-center p-6 bg-gray-50 rounded-xl">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Expertise e dedicação ao Jiu-Jitsu feminino
            </p>
          </div>
            ...
            <CardContent className="p-0">
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-8 lg:p-12 bg-white flex flex-col justify-center">
                  <h3 className="text-3xl text-black mb-4">Profa. Mariana Silva</h3>
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Faixa preta de Jiu-Jitsu com mais de 15 anos de experiência na arte suave, 
                    Mariana é especializada em ensinar mulheres de todos os níveis. Sua abordagem 
                    única combina técnica refinada com um ambiente acolhedor e empoderador.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="text-black">Campeã Mundial 2019</div>
                        <div className="text-sm text-gray-600">IBJJF Masters Division</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Formada pela Gracie Barra</div>
                      </div>
                    </div>
                  ...
                  <blockquote className="mt-8 border-l-4 border-black pl-4 italic text-gray-600">
                    "Minha missão é mostrar que toda mulher pode ser forte, confiante e capaz através do Jiu-Jitsu."
                  </blockquote>
                </div>
              </div>
            </CardContent>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="border-2 border-gray-200 hover:border-black hover:shadow-xl transition-all group">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Estacionamento gratuito e seguro para todas as alunas
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-gray-200 hover:border-black hover:shadow-xl transition-all group">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Vestiários femininos privativos com chuveiros
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-gray-200 hover:border-black hover:shadow-xl transition-all group">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Área de convivência com café e água para as alunas
                </p>
              </CardContent>
            </Card>
      ...
      <section id="myths" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Conheça a verdade sobre mulheres no Jiu-Jitsu e derrube as barreiras que te impedem de começar
            </p>
          </div>
                ...
                <div className="flex items-start gap-4 mb-6 pb-6 border-b border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-600 line-through">
                      "Jiu-Jitsu é muito violento para mulheres"
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-700">
                      É uma arte suave que prioriza técnica sobre força. O ambiente é controlado, 
                      seguro e adaptado ao ritmo de cada aluna.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-xs text-black mb-2 tracking-wider">REALIDADE</div>
                    <p className="text-lg text-gray-700">
                      O treino te coloca em forma! Começamos do absoluto zero e progredimos juntas, 
                      respeitando o corpo de cada uma.
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-700">
                      ...
                      e supervisionado por instrutoras experientes.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-xs text-black mb-2 tracking-wider">REALIDADE</div>
                    <p className="text-lg text-gray-700">
                      Temos alunas de 18 a 65 anos, todas prosperando e evoluindo. 
                      A idade é apenas um número quando se trata de empoderamento.
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 mb-6">
              Turmas exclusivas femininas com horários flexíveis
            </p>
          ...
          <div className="text-center mt-10">
            <p className="text-gray-500 text-sm mb-4">Todas as aulas são exclusivas para mulheres</p>
            <Button 
              size="lg"
              onClick={() => scrollToSection('contact')}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-2">
              Sem compromisso • Ambiente exclusivo para mulheres • Todas as idades e níveis
            </p>
          </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400">Jiu-Jitsu Feminino</div>
                </div>
              </div>
              <p className="text-gray-400 leading-relaxed">
                Empoderando mulheres através do Jiu-Jitsu desde 2010.
              </p>
            </div>
